...
description: 把公众号/搜狐/科普文章提炼成小红书卡片组（1080×1440 多图 JPG）。触发词：小红书卡片、小红书图文、科普卡片、文章做成卡片、卡片设计、做成小红书、图文卡片、知识卡片、文章转卡片、卡片组。包含文章抓取、原文配图解密（搜狐 AES）、3 风格设计、程序化校验、JPG 导出的完整工作流。
---
